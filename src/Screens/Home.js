        ...
        <><main>
            ...
            <section>
                <div className="grid grid-cols-12 lg:grid-cols-12 max-sm:grid-cols-6">
                    <div className="column1 max-sm:order-1 py-5 px-12 lg:col-span-7 md:col-span-7   max-sm:col-span-6">
            ...
            <section>
                <div className="accelerate">
                    <p className='text-center font-bold lg:text-[42px] max-sm:text-2xl max-sm:p-3'>Accelerate Your Career with PNY Training Institute's</p>
                </div>
                <div className="subaccel lg:flex lg:justify-center">
                    <p className='text-center lg:text-[18.5px] lg:w-[992px] max-sm:text-base p-3'>PNY Trainings Pakistan is the leading IT training institute, offering 100+ courses through online and physical classes. We provide internship opportunities and have a dedicated job cell to help you jumpstart your career</p>
                </div>
            </section>
            {/* -------------------------------------------------------- */}
            <section className='grid grid-cols-12 max-sm:ml-5'>
                <div className='lg:col-span-12  md:space-y-2 md:col-span-6  max-sm:space-y-2 max-sm:col-span-6 p-4 lg:flex  justify-center'>
                <div class="mainbox">
                <div class="roundedboxblue  max-sm:w-16 max-sm:h-16  lg:w-20 lg:h-20 p-5 rounded-3xl bg-blue-600 flex justify-center ml-5 ">
                  <div class="icon">
                    <img src={logo1} />
                  </div>
                </div>
