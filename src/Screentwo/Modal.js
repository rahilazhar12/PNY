  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div className="modalContainer bg-white p-4 rounded shadow-lg">
       ...
       <div className="flex justify-between"> <p className="text-gray-500">Started Date</p> 
       <p className="text-gray-500 mr-10">Days and Timing</p><p className="text-gray-500">Duration</p></div>


       <div className="ml-10">
  <p className="text-black">Monday 10 AM - 12 PM
 </p>
 <p className="text-black"> Tuesday 10 AM - 12 PM
 </p>
 <p className="text-black ml-5">Wednesday 10 AM - 12 PM
 </p>
</div>
