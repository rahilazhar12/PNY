        ...
        <Flowbite>
            <section className='p-4 '>
                <div className="grid lg:grid-cols-12 md:grid-cols-8 max-sm:space-y-1">
                    ...
                    <div className=' lg:col-span-2 md:col-span-2'>
                        <div className=' max-sm:flex max-sm:justify-center'>
                            <div class="dropdown dropdown-hover">
                                <label tabindex="0" class="btn max-sm:w-64 lg:w-[150px] md:w-[170px] xl:w-[220px]  h-[38px]  bg-[#308AFF] hover:text-black text-white hover:bg-[#308AFF] btn-sm"> <BiCategory /> Categories</label>
                    ...
                    <div className=' lg:col-span-12 xl:col-span-5 md:col-span-12'>
