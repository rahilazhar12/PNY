    ...
    return (
        <div className="bg-white p-4 shadow-md">
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
                ...
                <div className="relative flex flex-col lg:flex-row items-center space-x-2 mb-2 lg:mb-0 space-y-2 md:space-y-0">
                    <img src={PNYlogo} alt="PNY Logo" className="h-12" />
                    <section className="w-full">
                        <div className="group inline-block w-full text-center">
                            <button className="outline-none focus:outline-none border px-3 py-1 bg-blue-400 text-white h-[36px] rounded-lg flex items-center justify-center w-52 mx-auto">
                            ...
                            <ul className="bg-white border border-gray-200 z-50 rounded-lg shadow-lg transform scale-0 group-hover:scale-100 absolute transition duration-200 ease-in-out 
                ...
                <div className="flex-1 mb-4 lg:mb-0 mx-2">
                    ...
                    <ul className="results-scrollbar z-50 absolute w-60    md:w-[505px] lg:w-[450px] xl:w-[510px]  mt-1 max-h-96 overflow-y-auto bg-white">
                        {loading ? (
                ...
                <div className="flex space-x-4">
                    ...
                    <Link to="/about" className="text-sm font-bold">About Us</Link>
                    <Link to="/blog" className="text-sm font-bold">Blog</Link>
                    <Link to="/contactus" className="text-sm font-bold">Contact</Link>
                </div>
            </div>
        </div >
    );
