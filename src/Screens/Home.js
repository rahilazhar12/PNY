    ...
    <><main>
      ...
      <div class="grid">
          <div class=" flex justify-center">
            <p className=' lg:text-4xl max-sm:text-2xl max-sm:font-bold lg:font-bold max-sm:text-center'>Our Journey to Success</p>
          </div>

          <div class="PNYTrainingsPakistan p-2 justify-center flex">
            <p className='lg:font-normal text-center max-sm:font-medium max-sm:text-base lg:w-[880px]'>
