     ...
     <section className='bg-[#152438] text-white h-[400px] max-sm:h-auto dark:bg-slate-800 '>
       <div className='grid lg:grid-cols-12  dark:text-white'>
        <div className='col-span-6 mt-20 space-y-4' >
            <div className="title lg:ml-10 lg:text-lg max-sm:text-center">{data.title}</div>
            <div className="title lg:text-5xl lg:ml-10  max-sm:text-center max-sm:px-5">{data.description1}</div>
            <div className="title lg:ml-10 lg:text-lg  max-sm:text-center max-sm:px-5">{data.description}</div>
        </div>
