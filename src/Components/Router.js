  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/google-scholarship-certification-in-lahore-pakistan"
          element={<Googlecertification />}
        />
        ...
        <Route
          path="/short-courses-in-azad-kashmir"
          element={<Azadkashmir />}
        />
        <Route path="/blog/short-course-in-sialkot" element={<Sialkot />} />
        <Route
          path="/blog/short-course-in-sialkot/:slug"
          element={<Sialkotdetails />}
        />
