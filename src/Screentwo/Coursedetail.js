      ...
      {modulesData.map((module, index) => (
        <div
          ...
          className={`h-[auto] md:h-[113px] flex border border-black/25 shadow-lg justify-center items-center ${
            activeModule === index ? 'bg-blue-500 text-white' : ''
          }`}
